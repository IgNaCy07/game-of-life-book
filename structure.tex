...
\SetWatermarkText{Preprint z conwaylife.com/book (\today). \qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad ${}$}
...
\newtheorem{propositionT}[dummy]{Założenie}
\newtheorem{exerciseT}{Ćwiczenie}[chapter]
\theoremstyle{blacknumex}
\newtheorem{exampleT}{Przykład}[chapter]
\theoremstyle{blacknumbox}
\newtheorem{vocabulary}{Słowniczek}[chapter]
\newtheorem{definitionT}{Definicja}[chapter]
\theoremstyle{ocrenum}
...
\fi
\hypersetup{
	pdftitle = {Gra w Życie Conwaya - Matematyka i Konstrukcja},
	pdfauthor = {Nathaniel Johnston i Dave Greene}
}
\usepackage{bookmark}
\bookmarksetup{
open,
