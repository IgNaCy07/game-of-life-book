...
\begin{document}
	...
	\begin{tikzpicture}%
		...
		\draw[darkgray] (0.8,0.27) node {\scriptsize okres~$2p$};
		\filldraw[color=black,fill=gray!50] (2,0) -- (3.6,0) -- (3.6,0.6) -- (2,0.6) -- cycle;
		\draw[darkgray] (2.8,0.27) node {\scriptsize okres~$3p$};
		
		\draw[darkgray,decorate,decoration={brace,amplitude=10pt},yshift=1pt]
		(0,0.6) --node [anchor=north,yshift=22pt]{\footnotesize działa szybowców} (3.6,0.6);
		...
		(6,-0.7) --node [anchor=north,yshift=20pt]{\footnotesize działo LWSS} (8,-0.7);
