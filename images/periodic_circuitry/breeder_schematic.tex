...
\begin{document}
	...
	\begin{tikzpicture}%
		...
		(0,0) --node [anchor=north,yshift=-9pt]{\footnotesize działa (szybowców Gospera)} (6,0);
		...
		(11,2.7) --node [anchor=north,xshift=23pt,yshift=7pt]{\footnotesize grzebienie} (11,-1.7);
