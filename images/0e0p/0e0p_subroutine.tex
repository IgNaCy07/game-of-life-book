...
\begin{document}
	\begin{tikzpicture}%
		...
		\draw[gray,dashed] (3.42,9.03) -- (3.72,9.33) --node[rotate=-45,anchor=south,shift={(0.35,0)}]{\small\texttt{pętla podrutynowa CN}} (5.41,7.64) -- (5.11,7.34) -- cycle;
		
		\newcommand\ceadj{4.15}
		\newcommand\ceadjy{3.76}
		\draw[gray,dashed] (3.42+\ceadj,9.03-\ceadjy) -- (3.72+\ceadj,9.33-\ceadjy) --node[rotate=-45,anchor=south,shift={(-0.35,0)}]{\small\texttt{pętla podrutynowa CE}} (5.41+\ceadj,7.64-\ceadjy) -- (5.11+\ceadj,7.34-\ceadjy) -- cycle;
		...
		% ZOOM CN
			...
			\draw[color=gray,-stealth] (-3.3,7.5) --node[rotate=45,align=center,anchor=north]{\small\texttt{poczwórne wyjście}\\\small\texttt{do LW}} (-5.3,5.5);
		...
		% ZOOM LW
			...
			\draw[color=gray,-stealth] (-0.25,5.65) --node[rotate=45,align=center,anchor=south,shift={(0.1,0)}]{\small\texttt{poczwórne wejście}\\\small\texttt{z CN}} (-2.05,3.85);
		% END ZOOM BOX LW
