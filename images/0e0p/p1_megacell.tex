...
\begin{document}
	\begin{tikzpicture}%
		...
		\draw[color=gray,dashed] (2.72,4.02) -- (2.98,4.28) -- (5.55,1.71) -- (5.29,1.45) --node[rotate=-45,anchor=north,fill=white,fill opacity=0.8,text opacity=1]{\small\texttt{tablica podglądowa}} cycle;
		...
		\draw[gray] (\bglx+0.41,\bgty+0.07) to[out=135,in=180] (\bglx+0.9,\bgty+5) node[anchor=west,shift={(0,0.02)}]{\texttt{swój}};
