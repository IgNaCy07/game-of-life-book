...
\begin{document}
	\begin{tikzpicture}%
		...
		% ZOOM
			...
			% Rule labels
			\draw[color=gray] (-3.4,11.2+\yshft) node[anchor=north]{\large\texttt{tablica podglądowa}};
			
			%S
			\draw[color=gray] (-2.76,9.69+\yshft) node[anchor=north]{\Large\texttt{S}};
			\draw[color=gray,dashed] (-3.3,9.12+\yshft) rectangle (-2.25,2.42+\yshft);
			...
			\draw[color=gray] (-4.02,10+\yshft) node[anchor=north]{\Large\texttt{B}};
			\draw[color=gray,dashed] (-2.89+\xadj,9.12+\yadj+\yshft) rectangle (-1.84+\xadj,2.42+\yadj+\yshft);
			
			\draw[color=gray] (-2.55+\xadj,8.95+\yadj+\yshft) node[anchor=north]{\texttt{8}};
			\draw[color=gray] (-2.55+\xadj,8.42+\yadj+\yshft) node[anchor=north]{\texttt{7}};
			\draw[color=gray] (-2.55+\xadj,7.89+\yadj+\yshft) node[anchor=north]{\texttt{6}};
			
			\renewcommand\yadj{0.31-2.44}
			\draw[color=gray] (-2.55+\xadj,8.95+\yadj+\yshft) node[anchor=north]{\texttt{5}};
			\draw[color=gray] (-2.55+\xadj,8.42+\yadj+\yshft) node[anchor=north]{\texttt{4}};
			\draw[color=gray] (-2.55+\xadj,7.89+\yadj+\yshft) node[anchor=north]{\texttt{3}};
			
			\renewcommand\yadj{0.31-4.88}
			\draw[color=gray] (-2.55+\xadj,8.95+\yadj+\yshft) node[anchor=north]{\texttt{2}};
			\draw[color=gray] (-2.55+\xadj,8.42+\yadj+\yshft) node[anchor=north]{\texttt{1}};
			\draw[color=gray] (-2.55+\xadj,7.89+\yadj+\yshft) node[anchor=north]{\texttt{0}};
		% END ZOOM BOX
	\end{tikzpicture}
\end{document}
