...
\begin{document}
	...
	\begin{tikzpicture}[scale=0.25,rotate=315]%
%		Corner dots
...
%		\fill[fill=black] (64,64) circle (0.3);
		...
		% Red wires
		\draw[darkyellowback,thick] (52,15) -- (20,15) -- (20,16) -- (44,16) -- (44,17) -- (20,17) -- (20,18) -- (44,18) -- (44,19) -- (20,19) -- (20,20) -- (44,20) -- (44,21) -- (20,21) -- (20,22) -- (44,22) -- (44,23) -- (20,23) -- (20,24) -- (44,24) -- (44,25) -- (20,25) -- (20,26) -- (44,26) -- (44,27) -- (20,27) -- (20,28) -- (44,28) -- (44,29) -- (20,29) -- (20,30) -- (44,30) -- (44,31) -- (20,31) -- (20,32) -- (44,32) -- (44,33) -- (20,33) -- (20,34) -- (44,34) -- (44,35) -- (20,35) -- (20,36) -- (52,36) -- (52,15);
		\draw[darkmagentaback,thick] (50,12) -- (52,12) -- (52,15);
		...
		\draw[darkmagentaback,thick,-{Latex[length=2mm,width=1.5mm]}] (9,29) -- (9,55) -- (30,55) -- (30,69.5) node[anchor=south,rotate=-45,shift={(-1.1,0)}]{\texttt{wychodzący przepis}};
		\draw[darkmagentaback,thick,-{Latex[length=2mm,width=1.5mm]}] (30,55) -- (55,55) -- (55,33) -- (64.5,33);
        \draw[darkmagentaback,thick] (55,33) -- (55,9);
		\draw[darkyellowback,-{Latex[length=2mm,width=1.5mm]}] (48,36) -- (50.5,36);
		\draw[darkyellowback,-{Latex[length=2mm,width=1.5mm]}] (52,35) -- (52,33.2);
		\draw[darkyellowback,-{Latex[length=2mm,width=1.5mm]}] (51,15) -- (49.2,15);
		...
		\draw[darkgreenback,-{Latex[length=2mm,width=1.5mm]}] (49,19.5) -- (47,19.5);
		\fill[fill=darkyellowback] (52,15) circle (0.3);
		...
		\draw[darkmagentaback,dashed,thick,-{Latex[length=2mm,width=1.5mm]}] (55,55) -- (55, 67.75) node[anchor=south east,rotate=-45,shift={(0.5,0)}]{\texttt{konstrukcja}};
		...
		\draw[darkorangeback,thick,{angle 60 reversed[length=2mm,width=1.5mm]}-] (38,64.5) node[anchor=south west,shift={(-0.2,0.3)},rotate=315]{\texttt{wchodzący stan}} -- (38,52) -- (13,52) -- (13,13) -- (41,13);
		...
		\draw[darkaquaback,thick,-{Latex[length=2mm,width=1.5mm]}] (38,10.5) -- (10,10.5) -- (10,54) -- (26,54) -- (26,64.5) node[anchor=south east,shift={(0.25,-0.25)},rotate=315]{\texttt{wychodzący stan}};
		...
		% Green wires
		\draw[darkgreenback,thick,{angle 60 reversed[length=2mm,width=1.5mm]}-] (36,69.5) node[anchor=south,rotate=-45,shift={(1.1,0)}]{\texttt{wchodzący przepis}} -- (36,63) -- (62,63) -- (62,29);
		...
		\draw[darkaquaback] (45.5,12) node[rotate=315] {\texttt{logika}};
