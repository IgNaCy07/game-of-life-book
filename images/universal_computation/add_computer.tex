...
\begin{document}
	\begin{tikzpicture}%
		...
		\draw[gray] (\zoutx,\zouty) node[rotate=45] {\tiny \texttt{wyjście Z}};
		\draw[color=gray,-stealth] (\zoutx-0.3,\zouty-0.45) -- (\zoutx+0.5,\zouty+0.35);
		
		% NZ OUT
		\newcommand\nzoutx{5.81}
		\newcommand\nzouty{8.24}
		\draw[gray] (\nzoutx,\nzouty) node[rotate=45] {\tiny \texttt{wyjście NZ}};
		\draw[color=gray,-stealth] (\nzoutx-0.32,\nzouty-0.45) -- (\nzoutx+0.48,\nzouty+0.35);
		
		% Z IN
		\newcommand\nzinx{8.56}
		\newcommand\nziny{6.12}
		\draw[gray] (\nzinx,\nziny) node[rotate=-45] {\tiny \texttt{wejście Z}};
		\draw[color=gray,-stealth] (\nzinx-0.43,\nziny+0.29) -- (\nzinx+0.37,\nziny-0.51);
		
		% NZ IN
		\newcommand\zinx{8.97}
		\newcommand\ziny{6.53}
		\draw[gray] (\zinx,\ziny) node[rotate=-45] {\tiny \texttt{wejście NZ}};
		...
		\draw[gray] (3.4,4.8) node[rotate=45] {\scriptsize \texttt{Stos Komponent}};
		...
		\draw[gray] (10.15,1.95) node[rotate=45] {\scriptsize \texttt{Komputer}};
