...
\begin{document}
	\begin{tikzpicture}%
		\begin{scope}
			...
			% INPUT GLIDER
			\draw[gray] (0.35,0.15) node[rotate=-45] {\scriptsize wejściowy szybowiec \texttt{TEST}};
			...
			\draw[darkgray] (1.7,-1) node {\scriptsize duplikator};
			
			\draw[gray] (4.1,-2.4) node[rotate=-45] {\scriptsize próbny sygnał \texttt{Z} (``zero'')};
			\draw[thick,color=darkgray,-stealth] (2.7,-1.3) -- (5.3,-3.9) -- (6.3,-2.9);
			
			\draw[gray] (3.15,0.25) node[rotate=45,align=center] {\scriptsize próbny sygnał \\[-0.15cm] \scriptsize  \texttt{NZ} (``nie-zero'')};
...
%			\draw[black!8!white] (5.15+\sbshft,-0.8+\sbshft) node[anchor=north west,shift={(0.1,0.1)}] {\scriptsize 7};
	...
	%		\draw[black!2!white] (5.75+\sbshft,-0.2+\sbshft) node[anchor=north west,shift={(0.1,0.1)}] {\scriptsize 10};
			...
			\draw[darkgray] (8.7,-2.3) node[align=center] {\scriptsize blokuj \texttt{Z} jeśli \texttt{NZ} \\[-0.15cm] \scriptsize przychodzi z półn. wschodu \\[-0.15cm] \scriptsize (n.p., stoper szybowca)};
			...
			% NZ output
			\draw[darkgreenback!75!white] (8.35,-3.45) node[rotate=-45] {\scriptsize wyjście \texttt{NZ}};
			...
			\draw[darkgray] (9.1,-0.8) node {\scriptsize duplikator};
			
			% Z output reset block
			\draw[darkorangeback!75!white] (7.2,-0.5) node[rotate=45] {\scriptsize resetuj przesunięty blok 0};
			\draw[thick,color=darkorangeback,-stealth] (8.1,-0.5) -- (7.8,-0.2) -- (6.5,-1.5) -- (5.8,-0.8);
			
			% Z output
			\draw[darkorangeback!75!white] (10.75,-1.45) node[rotate=-45] {\scriptsize wyjście \texttt{Z}};
