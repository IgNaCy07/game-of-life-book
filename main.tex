...
\vspace*{0.3in}
\centering\textbf{\textsf{{\fontsize{38}{45}\selectfont Gra w życie Conwaya}}} \\[0.3in]
\textbf{\textsf{{\fontsize{24}{40}\selectfont Matematyka i konstrukcja}}} \\[1.2in]
...
\renewcommand{\chaptermark}[1]{\markboth{\sffamily\normalsize\bfseries Spis treści}{}} % Chapter text font settings
...
\appendix
\renewcommand\chaptername{Dodatek}
...
\addcontentsline{toc}{chapter}{\textcolor{ocre}{Indeks}}
\printindex
